...
$sql = "SELECT  `HF_name`, `HL_name`, `Hpassword` FROM `hiredtaxi` WHERE `HF_name` = '$FF_name' AND `HL_name` = '$FL_name' AND `Hpassword` = '$FFpassword'";
$resultHired = mysqli_query($conn, $sql);


$sql2 = "SELECT  `FF_name`, `FL_name`, `FFpassword` FROM `freelancetaxi` WHERE `FF_name` = '$FF_name' AND `FL_name` = '$FL_name' AND `FFpassword` = '$FFpassword'";
